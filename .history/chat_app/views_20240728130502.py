...
def ask_question(request):
    if request.method == "POST":
        ...
        response = chat.send_message(f" {user} pode fazer outros tipós de perguntas, como endereço, numeros de telefone etc sobre assuntos relacionados às políticas públicas voltadas para as mulheres"
        )
