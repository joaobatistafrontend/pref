...
def ask_question(request):
    if request.method == "POST":
        ...
        iniciativa = 'O assunto que o {user} é sobre responder perguntas frequentes e prestar suporte a assuntos relacionados às políticas públicas voltadas para as mulheres. Tenha conhecimento e forneça aconselhamento acessível para o {user}. Use as seguintes leis e contextos para ajudar: {contexto_inicial} e {contexto_de_estudos}. Foque em dados do Ceará. Mantenha o foco em responder perguntas frequentes e prestar suporte a assuntos relacionados às políticas públicas voltadas para as mulheres.'
        #receber o texto do usuario como parametro
        response = chat.send_message(f"{iniciativa}, mais o {user} pode fazer outros tipós de perguntas, como endereço, numeros de telefone etc"
        )
