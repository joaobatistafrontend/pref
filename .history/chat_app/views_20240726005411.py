...
def ask_question(request):
    if request.method == "POST":
        ...
        response = chat.send_message(f'o assunto que vamos conversa é sobre :{contexto_inicial} e {contexto_de_estudos},\
                                      eu sou uma mulher que preciso de suporte sobre esses assuntos, nao seidei o {user} \troca de assunto mantenha o foco em responder perguntas frequentes e prestar suportea assuntos relacionados às políticas públicas voltadas para as mulheres.')
