...
def ask_question(request):
    if request.method == "POST":
        ...
        response = chat.send_message(f'o assunto que vamos conversa é sobre responder perguntas frequentes e prestar suporte \a assuntos relacionados às políticas públicas voltadas para as mulheres 
