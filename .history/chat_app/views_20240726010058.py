...
def ask_question(request):
    if request.method == "POST":
        ...
        response = chat.send_message(f'o assunto que vamos conversa é sobre responder perguntas frequentes e prestar suporte \ 
                                        a assuntos relacionados às políticas públicas voltadas para as mulheres, tenha conhecimento \
                                        e um aconcelhamento acessivel para o usuario, essas leis possa te ajudar
                                        {contexto_inicial} e {contexto_de_estudos}, tenha os dados do ceara,\
                                        eu sou uma mulher que preciso de suporte sobre esses assuntos, nao deixe o {user} \
