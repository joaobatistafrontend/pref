...
class AskQuestionView(LoginRequiredMixin, View):
    def post(self, request):
        ...
        response_data = { #parametro que precisa para trazer a resposta da ia
...
class ChatRoomView(LoginRequiredMixin,TemplateView):
    ...
    def post(self, request, room_name):
        room = get_object_or_404(SalaMeninas, name=room_name)
        content = request.POST.get('message', '').strip() #acessar o valor associado a uma chave específica  / remover quaisquer espaços em branco
