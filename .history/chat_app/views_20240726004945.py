...
from .treinamentos import contexto_inicial, 
#chave api
...
def ask_question(request):
    if request.method == "POST":
        ...
        response = chat.send_message(f'o assunto que vamos conversa é sobre :{contexto_inicial} e , eu sou uma mulher que preciso de suporte sobre esses assuntos')
