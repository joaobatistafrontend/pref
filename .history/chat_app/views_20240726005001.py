...
def ask_question(request):
    if request.method == "POST":
        ...
        response = chat.send_message(f'o assunto que vamos conversa é sobre :{contexto_inicial} e {contexto_de_estudos}, eu sou uma mulher que preciso de suporte sobre esses assuntos, nao seixei o ')
